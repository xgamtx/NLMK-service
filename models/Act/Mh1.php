...
class Mh1 extends BaseAct {
    protected $actTemplatePath = '/web/disa3.xlsx';
    ...
    protected function setModel(Carriage $carriage) {
        ...
        $this->valueForReplace = array(
            ...
            '{wheelset_1_price}' => $wheelSets[0]->getPartInfo()->price,
            '{wheelset_2_price}' => $wheelSets[1]->getPartInfo()->price,
            '{wheelset_3_price}' => $wheelSets[2]->getPartInfo()->price,
            '{wheelset_4_price}' => $wheelSets[3]->getPartInfo()->price,
            ...
            '{bolster_1_price}' => $bolsters[0]->getPartInfo()->price,
            '{bolster_2_price}' => $bolsters[1]->getPartInfo()->price,
            ...
            '{side_frame_1_price}' => $sideFrames[0]->getPartInfo()->price,
            '{side_frame_2_price}' => $sideFrames[1]->getPartInfo()->price,
            '{side_frame_3_price}' => $sideFrames[2]->getPartInfo()->price,
            '{side_frame_4_price}' => $sideFrames[3]->getPartInfo()->price,
